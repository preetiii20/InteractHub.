...
import { LayoutDashboard, User, MessageSquare, Megaphone, CheckCircle, Calendar, CalendarDays, LogOut, ChevronLeft, ChevronRight } from 'lucide-react';
...
const menu = [
  ...
  { to: '/dashboard/hr/calendar', label: 'Calendar', icon: CalendarDays }
];
        ...
        <div className="flex flex-col h-screen w-full overflow-hidden bg-slate-100">
            ...
            <header className="h-20 flex-shrink-0 bg-gradient-to-r from-blue-700 via-blue-600 to-cyan-700 border-b-4 border-blue-900 px-8 flex items-center justify-between shadow-2xl">
                <div className="flex items-center gap-4 h-full">
                    ...
                    <div className="text-white text-base font-bold opacity-100 tracking-widest drop-shadow-md">HR PORTAL</div>
                </div>
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                {/* Main Content */}
                <main className={`flex-1 flex flex-col ${location.pathname.startsWith('/dashboard/hr/communication') ? 'overflow-hidden' : 'overflow-y-auto'} bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50`}>
                    <div className={`flex-1 ${location.pathname.startsWith('/dashboard/hr/communication') ? 'overflow-hidden p-0' : 'overflow-y-auto p-8'}`}>
