...
import { LayoutDashboard, Users, MessageSquare, Video, BarChart3, FileText, LogOut } from 'lucide-react';
...
const AdminLayout = () => {
    ...
    return (
        <div className="flex flex-col h-screen w-full overflow-hidden bg-white">
            {/* Full Width Header */}
            <header className="h-20 flex-shrink-0 bg-gradient-to-r from-blue-600 via-blue-500 to-blue-700 border-b border-blue-800 px-8 flex items-center justify-between shadow-lg">
                <div className="flex items-center gap-4 h-full">
                    <div className="text-3xl font-bold text-white">Interacthub</div>
                    <div className="h-8 w-0.5 bg-white opacity-40"></div>
                    <div className="text-white text-sm font-semibold opacity-90 tracking-wide">ADMIN PORTAL</div>
                </div>
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <main className="flex-1 flex flex-col overflow-hidden bg-gradient-to-br from-indigo-50 via-blue-50 to-purple-50">
                    <div className="flex-1 overflow-y-auto p-8 scroll-smooth bg-gradient-to-br from-indigo-50 via-blue-50 to-purple-50">
